...
c	parameter(nx=576,ny=181,nz=14) 
	parameter(nx=576,ny=361,nz=14)   !  for u, v, t
c	parameter(nx=576,ny=361,nz=1)   !  for ps
...
c input file  
	...
	open(1,file='../temp/${var}_L14_intp', 
c       open(1,file='T_L14_576x361_merra.7911', 
c	open(1,file=
c     *'../../../Data/MERRA/PS-576361/PS-DJFcli7911.bdat', 
     *form='unformatted',access='direct',recl=nx*ny*nz*4) 

c output file  

        open(2,file='../temp/${var}_R30L14',
